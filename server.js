...
// ======================================================================
// == PENTING: TAMBAHAN UNTUK MELAYANI FILE STATIS (FRONTEND) ==
// Ini akan melayani semua file HTML, CSS, JavaScript, gambar, dll.
// yang ada di direktori yang sama dengan 'server.js' sebagai file statis.
// Tempatkan ini SEBELUM route API spesifik Anda (seperti '/send-order').
